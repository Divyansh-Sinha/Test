...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Question[] questions = new Question[]{
            ...
            new Question(R.string.question_grammar_1, false),
            new Question(R.string.question_grammar_2, true),
            new Question(R.string.question_grammar_3,true),
            new Question(R.string.question_grammar_4,true),
    };
    ...
    public void onClick(View v) {
        switch(v.getId()){
            ...
            case R.id.maths_section:
                Intent intent = new Intent(MainActivity.this, QuizQuestions.class);//Intent is to go from this activity to MathsQuestions Activity
